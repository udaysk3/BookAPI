...
SECRET_KEY = 'django-insecure-++@=ivz6h84q2!d&vd5ww2hrkpv_&weket0&i+3tya%m-*9wt3'
...
import json
EMAIL_CONFIG_FILE = os.path.join(BASE_DIR, 'config.json')
with open(EMAIL_CONFIG_FILE, 'r') as config_file:
